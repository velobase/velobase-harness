...
免费开源的 ShipFast-style 替代选择，面向 AI SaaS builder。
...
- **极客时间《产品二姐》AI SaaS 课程:** 课程在讨论 AI SaaS 工程底座时提到 Harness，并把它作为 ShipFast、ShipAny 等选择之外的开源参考。如果你是从这篇内容看到 Harness，可以直接从上面的 [快速本地启动](#快速本地启动) 开始。
